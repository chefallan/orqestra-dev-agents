# Autonomous Copilot Agent System (Orchestrator + Specialists)
...
Intended environment: VS Code with GitHub Copilot Chat in Agent mode.
...
- Officially supported: VS Code with GitHub Copilot Chat in Agent mode.
- Not officially supported: other IDEs/editors (for example JetBrains, Visual Studio, Vim/Neovim, Eclipse).
- You may still reuse generated files and runtime components outside VS Code, but feature parity with the intended workflow is not guaranteed.

## Quick Start

1. Open this repository in VS Code.
2. Open Copilot Chat in Agent mode.
3. Select the orchestrator agent spec from `agents/orchestrator.agents.md`.
4. Give a goal, for example:
...
6. Open the repo in VS Code and open Copilot Chat in Agent mode.

7. Select `agents/orchestrator.agents.md` as your main agent spec.
   - If `.github/copilot-instructions.md` is present, you can directly talk to the orchestrator without pasting spec content.
...
2. Open Copilot Chat in Agent mode.
3. Use `agents/orchestrator.agents.md` (or rely on `.github/copilot-instructions.md`).
